    ...
    <body>
      <header>
          <div class="section-header">
            <p>STS setup wizard</p>
            <a href="https://nitikesh.info" target="_blank">Get Support</a>
          </div>
      </header>
      <!-- First Section Start -->
  ...
  $api = "http://nitikesh.info/verify/api.php?code=$code&user=$user&domain=$base_url";
